...
[TestFixture]
public class GivenARequestToAsignSupportEngineerToComplaint
{
    ...
    {
        Assert.That(assignedComplaints.Complaints.FirstOrDefault().Reference, Is.EqualTo(complaintReference));
    }
}