# Secruity - Access Control

* Status: accepted
* Deciders: Alex Dobson
* Date: 2025-12-08

Technical Story: Need a way to be able to deciide if a user can access specific features of the solution
...
* Appropriateness to Project Breif
...
Chosen option: "Role Based", because the project specification has a set of clearly defined roles, this means that Role Based access is the obvious choice for this project. Role Based Access Contorol will likely also match client company structure
...
* Good, because More flexable, you can remove access to features
