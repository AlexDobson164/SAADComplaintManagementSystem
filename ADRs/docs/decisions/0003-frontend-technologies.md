...
Chosen option: "Blazor", because I am much more confident with C# than I am with JS or TS. Angular was the frontend framework that was used by my placement, meaning I have some experience with it, but my position was as a backend developer so I don't have much experience with it. I have also used Blazor a bit before, meaning I have a similar amount of experience with both options. Both options have learning curves but as I am already using .NET for the backend, the learning curve will be less for Blazor.
...
* Good, because Uses components, meaning that elements of the site can easily be reused
...
* Bad, because When Blazor first released, there were concerns about it not scaling very well. I can not find this concern for modern versions though.
